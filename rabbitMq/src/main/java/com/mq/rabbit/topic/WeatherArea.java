...
public class WeatherArea {
    ...
    public static void main(String[] args) throws Exception{
        ...
        areaMap.put("china.henan.zhengzhou.20210628","河南郑州20210628日天气状况良好！");
        areaMap.put("china.henan.xinyang.20210627","河南信阳20210627日天气状况良好！");
        areaMap.put("china.shanghai.putuo.20210628","上海普陀20210628日天气状况良好！");
        areaMap.put("china.beijign.haidian.20210627","北京海淀20210627日天气状况良好！");
        areaMap.put("us.NewYork.abc.20210627","美国纽约20210627日天气状况良好！");

        areaMap.entrySet().forEach(item ->{
            item.getKey();
            try {
                // 交换机名，routing key，，队列信息
                channel.basicPublish(RabbitConstant.EXCHANGE_WEATHER_TOPIC,item.getKey(),null,item.getValue().getBytes());
            } catch (IOException e) {
                e.printStackTrace();
            }
        });
